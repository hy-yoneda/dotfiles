...
" - * File: .vimrc
" - * Author: itchyny
" - * Last Change: 2018/05/08 10:28:51.
" --------------------------------------------------------------------------------------------------------
...
NeoBundleLazy 'Shougo/vimfiler', {'autoload': {'commands': ['VimFiler', 'VimFilerBufferDir']}, 'depends' : ['unite.vim', 'vinarise']}
  ...
  let g:vimfiler_ignore_pattern = '^\.\|\.\%(o\|hi\)$\|^dist$'
...
NeoBundleLazy 'eagletmt/ghci-vim', {'autoload': {'filetypes': ['haskell']}, 'disabled': !executable('ghc-mod')}
